...
public:
    ...
    bool load(double& timestamp, cv::Mat& img_front, cv::Mat& img_left, cv::Mat& img_right, cv::Mat& img_rear){
        ...
        if(std::getline(json_ifs_, line)){
            ...
            std::string img_front_path = path_ + "/" + obj.Get<std::string>("img_front_path");
            std::string img_left_path = path_ + "/" + obj.Get<std::string>("img_left_path");
            std::string img_right_path = path_ + "/" + obj.Get<std::string>("img_right_path");
            std::string img_rear_path = path_ + "/" + obj.Get<std::string>("img_rear_path");
